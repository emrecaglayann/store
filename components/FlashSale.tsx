...
const FlashSale = ({ products }: Props) => {
    ...
    useEffect(() => {
        ...
        const calculateTimeUnits = (timeDiffarence: number) => {
            const seconds = Math.floor(timeDiffarence / 1000 );
            setTimeUnits({
        ...
        const updateCountdown = () => {
            ...
            const experiryTime = saleEndDate.getTime();
            const timeDiffarence = experiryTime - currentDate;

            if( timeDiffarence <= 0 ) {
                calculateTimeUnits(0);
            } else
            {
                calculateTimeUnits(timeDiffarence);
            }
        }
        updateCountdown();
